...
def jarvis_layout(body: str, active: str, title: str, boot: bool = False) -> str:
    ...
    boot_html = '<div id="boot" class="boot"><div class="boot-stage"><div class="boot-halo halo-a"></div><div class="boot-halo halo-b"></div><div class="boot-ticks"></div><div class="boot-orbit"><div class="boot-core" aria-label="系統核心"><i></i><b></b></div></div><div class="boot-needle"></div></div><div class="boot-kicker">極速財務核心</div><h1>曜核智控</h1><p id="boot-line">正在點火...</p><div class="boot-track"><i></i></div><div class="boot-status"><span>動力核心</span><span>資料鏈路</span><span>AI 引擎</span></div></div>' if boot else ""
    css = r'''
    ...
    *{box-sizing:border-box}html{background:var(--bg)}body{margin:0;min-height:100vh;color:var(--text);font-family:var(--ui);background:radial-gradient(circle at 83% 0%,rgba(92,65,255,.19),transparent 35%),radial-gradient(circle at 8% 30%,rgba(0,210,255,.11),transparent 28%),linear-gradient(145deg,var(--bg),var(--bg2) 58%,#030710);overflow-x:hidden}body:before{content:"";position:fixed;inset:0;pointer-events:none;opacity:.16;background-image:linear-gradient(45deg,rgba(255,255,255,.018) 25%,transparent 25%,transparent 75%,rgba(255,255,255,.018) 75%),linear-gradient(45deg,rgba(255,255,255,.018) 25%,transparent 25%,transparent 75%,rgba(255,255,255,.018) 75%);background-size:8px 8px;background-position:0 0,4px 4px}a{color:inherit;text-decoration:none}
    ...
    .brand-mark{animation:coreIgnite 3.2s ease-in-out infinite}.brand-mark:before{content:"";position:absolute;inset:-7px;border-radius:19px;border:1px solid rgba(54,214,255,.18);animation:pulse 2.2s ease-in-out infinite}
    ...
    return f'''<!doctype html><html lang="zh-Hant"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1,viewport-fit=cover"><meta name="theme-color" content="#03060d"><title>{escape(title)}</title><style>{css}</style></head><body><div class="app-shell"><aside class="sidebar"><div class="brand-block"><div class="brand-mark"><span>◆</span></div><div class="brand-text"><b>曜核智控</b><small>超跑財務核心</small></div></div><nav class="nav-stack">{nav}</nav><div class="side-status"><div class="online"><i class="pulse-dot"></i><span>系統正常</span></div><small>財務資料已同步<br>AI 助理待命中</small></div></aside><div class="content-wrap"><header class="topbar"><div class="top-title"><h1>{escape(title)}</h1><p><span data-date>載入日期中</span> · <span data-clock>--:--</span></p></div><div class="top-actions"><div class="status-pill"><i class="pulse-dot"></i>系統正常</div><a class="icon-btn" href="/jarvis/command">✦</a><a class="icon-btn" href="/admin">⚙</a></div></header><header class="mobile-header"><div class="mobile-brand"><div class="brand-mark"><span>◆</span></div><div><b>曜核智控</b><small>超跑財務核心</small></div></div><div class="mobile-actions"><a class="icon-btn" href="/jarvis/command">✦</a><a class="icon-btn" href="/admin">⚙</a></div></header><main>{body}<footer>曜核智控 4.6 Apex Drive · 電腦與手機雙介面</footer></main></div></div><nav class="mobile-nav">{mobile_nav}</nav>{boot_html}{script}</body></html>'''
